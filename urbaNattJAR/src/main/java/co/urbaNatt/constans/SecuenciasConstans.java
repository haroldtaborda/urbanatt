...
public class SecuenciasConstans {

	public static final String SEC_USUARIOS = "SEC_USUARIOS";
	public static final String SEC_CLIENTES= "SEC_CLIENTES";
	public static final String NEXTVAL = "NEXTVAL";
	public static final String PUNTO = ".";
	
	public static final String NEXT_USUARIOS = SEC_USUARIOS + PUNTO + NEXTVAL;
	
	public static final String NEXT_SUCURSALES = "SEC_SUCURSALES" + PUNTO + NEXTVAL;
