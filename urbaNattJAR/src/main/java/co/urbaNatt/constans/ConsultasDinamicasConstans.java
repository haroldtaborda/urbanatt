...
public class ConsultasDinamicasConstans {
	...
	public static final String CONSULTAR_PRODUCTO = "SELECT ID_PRODUCTO, NOMBRE, TIPO,UNIDAD,DESCRIPCION,CANTIDAD,VALOR PESO FROM PRODUCTOS WHERE ID_PRODUCTO IS NOT NULL  " ;
	...
	public static final String CONSULTAR_FACTURA_BASE ="SELECT DISTINCT F.ID_FACTURA,F.NUMERO_FACTURA,F.ID_CLIENTE, F.FECHA_CREACION, F.FECHA_FACTURA, F.VALOR_DEUDA, F.VALOR_PAGADO, F.ESTADO, F.VALOR_FACTURA, F.DESCRIPCION, C.NOMBRECOMPLETO, F.TIPO, F.ID_SUCURSAL, S.NOMBRESUCURSAL FROM FACTURAS F "+ 
   " INNER JOIN CLIENTES C ON C.NUMID =F.ID_CLIENTE LEFT JOIN SUCURSALES S ON S.ID_SUCURSAL=F.ID_SUCURSAL  WHERE F.ID_FACTURA IS NOT NULL ";
	...
	public static final String CONSULTAR_FACTURA_NUMID = " AND ID_CLIENTE = ? ";
