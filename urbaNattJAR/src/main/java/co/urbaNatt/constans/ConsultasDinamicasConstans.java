...
public class ConsultasDinamicasConstans {
	...
	public static final String CONSULTAR_FACTURA_BASE ="SELECT DISTINCT F.ID_FACTURA,F.NUMERO_FACTURA,F.ID_CLIENTE, F.FECHA_CREACION, F.FECHA_FACTURA, F.VALOR_DEUDA, F.VALOR_PAGADO, F.ESTADO, F.VALOR_FACTURA, F.DESCRIPCION, C.NOMBRECOMPLETO, F.TIPO, F.ID_SUCURSAL, S.NOMBRESUCURSAL, F.DESCUENTO, F.VENDEDOR, sysdate-TO_DATE(F.FECHA_FACTURA, 'dd/MM/yyyy') FROM FACTURAS F "+ 
