app.controller(
				...
				function($state, $scope, MESSAGES, CONFIG,
						$uibModal, $filter, comprasSvc, usuariosSvc, productosSvc, $rootScope) {
					...
					$scope.consultarAbonos = function(factura) {
						...
						.open({
							...
							controller : function($scope) {
								$scope.abonosTabla =[];
								comprasSvc.consultarAbonos(factura.idFactura).then(function(res) {
									if (res.data != null) {
					...
					$scope.buscarUsuarios = function() {
						...
						us.numeroId = $scope.numeroId == null || $scope.numeroId == '' ? "TODOS"
								: $scope.numeroId;
						us.laboratorio = $scope.laboratorio == null || $scope.laboratorio == '' ? "TODOS"
								: $scope.laboratorio;
						
						comprasSvc.consultasFacturas(us).then(function(res) {
							if (res.data != null) {
